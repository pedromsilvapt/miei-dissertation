...
\end{center}
	...
	Para além de permitir descrever notas, também é possível ter modificadores de contexto que permitem alterar as configurações que ditam a forma de criação das notas e acordes à sua frente, por exemplo.
