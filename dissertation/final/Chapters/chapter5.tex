...
Para esse efeito escolhemos a biblioteca \textbf{lark}\footnote{Lark Website \url{https://lark-parser.readthedocs.io/en/latest/}}. Esta biblioteca tem várias funcionalidades que captaram o nosso interesse:
\begin{description}
