...
A sintaxe que descrevemos acima foi implementada com recurso ao gerador de \textit{parsers} com base em gramáticas \acrshort{peg}, \textbf{Arpeggio} (cujo nome é irónico, tendo em conta o tema desta dissertação).
...
As produções para descrever teclados são um ponto fulcral na nossa gramática e na utilização da nossa linguagem em geral. Nós quisemos que elas permitissem descrever teclados de uma forma concisa, mas ainda assim dando bastante poder ao utilizador na forma como o utiliza.
...
\subsection{Parser}
Para implementar o \textit{parser} da linguagem, foi utilizado o módulo \textit{Python} \textbf{Arpeggio}, um módulo que implementa um algoritmo de \textit{parsing} descendente recursivo com recurso a \textit{memoization} para melhorar a \textit{performance}.
...
\begin{figure}[ht]
  ...
  \fbox{\includegraphics[width=.95\linewidth]{./img/syntax_highlight.png}}%
  }%
...
\begin{figure}[ht]
  ...
  \setlength{\fboxsep}{0pt}%
  \setlength{\fboxrule}{0pt}%
  \fbox{\includegraphics[width=.95\linewidth]{./img/documentation.png}}%
  }%
...
\begin{figure}[ht]
  ...
  \setlength{\fboxsep}{0pt}%
  \setlength{\fboxrule}{0pt}%
  \fbox{\includegraphics[width=.95\linewidth]{./img/error_reporting.png}}%
  }%
